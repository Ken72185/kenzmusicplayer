...
let songs = [
...

    {
        ...
        lyrics: [
            ...
            { time: 86, text: "Sing us a song, you're the piano man" },
            { time: 90, text: "Sing us a song tonight" },
            { time: 94, text: "Well, we're all in the mood for a melody" },
  ...
  artist: "Bruno Mars",
  album: "Single",
  albumArtUrl: "song/riskitall.png",
  audioSrc: "song/Risk It All - Bruno Mars.mp3",
  videoBgSrc: "video/riskitall.mp4",
  lyrics: [
    { time: 27, text: "For just the chance to win your heart" },
    { time: 32, text: "You could set the bar beyond the stars" },
    { time: 38, text: "I'll do anything, anything you ask me to" },
    { time: 48, text: "Say you want the moon" },
    { time: 51, text: "Watch me learn to fly" },
    { time: 53, text: "Ain't no mountain you could point to" },
    { time: 57, text: "I wouldn't climb" },
    { time: 59, text: "It's crazy, but it's true" },
    { time: 62, text: "There's nothing I won't do" },
    { time: 65, text: "I'd risk it all for you" },
    { time: 71, text: "To hold your hand and call you mine" },
    { time: 77, text: "I'm tryna be your man 'til the end of time" },
    { time: 82, text: "Oh, I'll do anything, anything you ask me to" },
    { time: 92, text: "I would run through a fire" },
    { time: 96, text: "Just to be by your side" },
    { time: 99, text: "If your heart's on the line" },
    { time: 101, text: "You could take mine" },
    { time: 104, text: "It's crazy, but it's true" },
    { time: 106, text: "There's nothing I won't do" },
    { time: 109, text: "I'd risk it all for you" },
    { time: 116, text: "I would swim across the sea just to show you" },
    { time: 122, text: "Sacrifice my life just to hold you" },
    { time: 127, text: "I could go on and on" },
    { time: 129, text: "To prove that you belong here in my arms" },
    { time: 159, text: "Say you want the moon" },
    { time: 162, text: "Watch me learn to fly" },
    { time: 165, text: "Ain't no mountain you could point to" },
    { time: 169, text: "I wouldn't climb" },
    { time: 171, text: "It's crazy, but it's true" },
    { time: 174, text: "There's nothing I won't do" },
    { time: 177, text: "I'd risk it all for you" },
    { time: 182, text: "It's crazy, but it's true" },
    { time: 185, text: "There's nothing I won't do" },
    { time: 188, text: "I'd risk it all for you" }
  ]
},

{
  ...
  album: "My World 2.0",
  albumArtUrl: "song/thatshouldbeme.jpg",
  audioSrc: "song/That Should Be Me - Justin Bieber.mp3",
  videoBgSrc: "video/thatshouldbeme.mp4",
  lyrics: [
    { time: 14, text: "Everybody's laughin' in my mind" },
    { time: 21, text: "Rumours spreadin' 'bout this other guy" },
    { time: 27, text: "Do you do what you did when you did with me?" },
    { time: 30, text: "Does he love you the way I can?" },
    { time: 34, text: "Did you forget all the plans that you made with me?" },
    { time: 38, text: "'Cause, baby, I didn't" },
    { time: 41, text: "That should be me holdin' your hand" },
    { time: 44, text: "That should be me makin' you laugh" },
    { time: 47, text: "That should be me, this is so sad" },
    { time: 51, text: "That should be me, that should be me" },
    { time: 54, text: "That should be me feelin' your kiss" },
    { time: 57, text: "That should be me buyin' you gifts" },
    { time: 61, text: "This is so wrong, I can't go on" },
    { time: 65, text: "'Til you believe that that should be me, that should be me" },
    { time: 75, text: "You said you needed a little time for my mistakes" },
    { time: 82, text: "It's funny how you used that time to have me replaced" },
    { time: 89, text: "Did you think that I wouldn't see you out at the movies?" },
    { time: 93, text: "What you doin' to me?" },
    { time: 95, text: "You're takin' him where we used to go" },
    { time: 97, text: "Now, if you're tryna break my heart, it's working 'cause you know that" },
    { time: 103, text: "That should be me holdin' your hand" },
    { time: 105, text: "That should be me makin' you laugh" },
    { time: 107, text: "That should be me, this is so sad" },
    { time: 112, text: "That should be me, that should be me" },
    { time: 116, text: "That should be me feelin' your kiss" },
    { time: 119, text: "That should be me buyin' you gifts" },
    { time: 123, text: "This is so wrong, I can't go on" },
    { time: 126, text: "'Til you believe that that should be me" },
    { time: 131, text: "I need to know, should I fight for love or disarm?" },
    { time: 138, text: "It's gettin' harder to shield this pain in my heart" },
    { time: 157, text: "Oooh" },
    { time: 159, text: "That should be me holdin' your hand" },
    { time: 162, text: "That should be me makin' you laugh" },
    { time: 165, text: "That should be me, this is so sad" },
    { time: 169, text: "That should be me, that should be me" },
    { time: 173, text: "That should be me feelin' your kiss" },
    { time: 176, text: "That should be me buyin' you gifts" },
    { time: 179, text: "This is so wrong, I can't go on" },
    { time: 183, text: "'Til you believe that that should be me" },
    { time: 190, text: "Holdin' your hand, that should be me" },
    { time: 194, text: "The one makin' you laugh oh baby, oh that should be me" },
    { time: 203, text: "That should be me givin' you flowers, that should be me talking for hours" },
    { time: 212, text: "That should be me, that should be me, that should be me" },
...

{
  ...
  artist: "Travis Scott",
  album: "Single",
  albumArtUrl: "song/highestintheroom.png",
  audioSrc: "song/Highest In The Room - Travis Scott.mp3",
  videoBgSrc: "video/highestintheroom.mp4",
  lyrics: [
    { time: 13, text: "I got room in my fumes (Yeah)" },
    { time: 18, text: "She fill my mind up with ideas" },
    { time: 21, text: "I'm the highest in the room (It’s lit)" },
    { time: 24, text: "Hope I make it outta here (Let's go)" },
    { time: 27, text: "She saw my eyes, she know I'm gone (Ah)" },
    { time: 30, text: "I see some things that you might fear" },
    { time: 33, text: "I’m doin' a show, I'll be back soon (Soon)" },
    { time: 37, text: "That ain't what she wanna hear (Nah)" },
    { time: 40, text: "Now I got her in my room (Ah)" },
    { time: 43, text: "Legs wrapped around my beard" },
    { time: 46, text: "Got the fastest car, it zoom (Skrrt)" },
    { time: 49, text: "Hope we make it outta here (Ah)" },
    { time: 53, text: "When I'm with you, I feel alive" },
    { time: 56, text: "You say you love me, don't you lie (Yeah)" },
    { time: 59, text: "Won't cross my heart, don't wanna die" },
    { time: 62, text: "Keep the pistol on my side (Yeah)" },
    { time: 66, text: "Case it’s fumes (Smoke)" },
    { time: 68, text: "She fill my mind up with ideas (Straight up)" },
    { time: 71, text: "I’m the highest in the room (It's lit)" },
    { time: 74, text: "Hope I make it outta here (Let’s go, yeah)" },
    { time: 77, text: "We ain't stressin' 'bout the loot (Yeah)" },
    { time: 81, text: "My block made of quesería" },
    { time: 84, text: "This not the molly, this the boot" },
    { time: 87, text: "Ain’t no comin' back from here" },
    { time: 90, text: "Live the life of La Familia" },
    { time: 93, text: "It's so much gang that I can't see ya (Yeah)" },
    { time: 96, text: "Turn it up 'til they can't hear (We can't)" },
    { time: 99, text: "Runnin', runnin' 'round for the thrill" },
    { time: 102, text: "Yeah, dawg, dawg, 'round my real (Gang)" },
    { time: 105, text: "Raw, raw, I been pourin' to the real (Drank)" },
    { time: 108, text: "Nah, nah, nah, they not back of the VIP (In the VIP)" },
    { time: 112, text: "Gorgeous, baby, keep me hard as steel" },
    { time: 115, text: "Ah, this my life, I did not choose" },
    { time: 118, text: "Uh, been on this since we was kids" },
    { time: 121, text: "We gon' stay on top and break the rules" },
    { time: 124, text: "Uh, I fill my mind up with ideas" },
    { time: 128, text: "Case it's fumes" },
    { time: 131, text: "She fill my mind up with ideas (Straight up)" },
    { time: 134, text: "I'm the highest in the room (I'm the highest, it's lit)" },
    { time: 137, text: "Hope I make it outta here" }
  ]
},

{
  ...
  artist: "Ed Sheeran",
  album: "÷ (Divide)",
  albumArtUrl: "song/dive.jpg",
  audioSrc: "song/Dive - Ed Sheeran.mp3",
  videoBgSrc: "video/dive.mp4",
  lyrics: [
    { time: 10, text: "Oh, maybe I came on too strong" },
    { time: 15, text: "Maybe I waited too long" },
    { time: 21, text: "Maybe I played my cards wrong" },
    { time: 23, text: "Oh, just a little bit wrong" },
    { time: 26, text: "Oh, baby, I apologise for it" },
    { time: 32, text: "I could fall or I could fly" },
    { time: 35, text: "Here in your aeroplane" },
    { time: 37, text: "And I could live, I could die" },
    { time: 39, text: "Hangin' on the words you say" },
    { time: 42, text: "And I've been known to give my all" },
    { time: 45, text: "And jumpin' in harder than" },
    { time: 47, text: "Ten thousand rocks on the lake" },
    { time: 51, text: "So don't call me \"baby\"" },
    { time: 57, text: "Unless you mean it" },
    { time: 61, text: "And don't tell me you need me" },
    { time: 67, text: "If you don't believe it" },
    { time: 71, text: "So let me know the truth" },
    { time: 74, text: "Before I dive right into you" },
    { time: 79, text: "You're a mystery" },
    { time: 82, text: "I have travelled the world" },
    { time: 84, text: "And there's no other girl like you, no one" },
    { time: 90, text: "What's your history? (What's your history?)" },
    { time: 93, text: "Do you have a tendency to lead some people on?" },
    { time: 97, text: "'Cause I heard you do, mm" },
    { time: 102, text: "I could fall or I could fly" },
    { time: 104, text: "Here in your aeroplane" },
    { time: 107, text: "And I could live, I could die" },
    { time: 109, text: "Hangin' on the words you say" },
    { time: 112, text: "And I've been known to give my all" },
    { time: 115, text: "And lie awake every day" },
    { time: 117, text: "Don't know how much I can take" },
    { time: 121, text: "So don't call me \"baby\"" },
    { time: 126, text: "Unless you mean it" },
    { time: 131, text: "And don't tell me you need me" },
    { time: 137, text: "If you don't believe it" },
    { time: 141, text: "So let me know the truth" },
    { time: 143, text: "Before I dive right into you" },
    { time: 170, text: "Mm, I could fall or I could fly" },
    { time: 173, text: "Here in your aeroplane" },
    { time: 176, text: "And I could live, I could die" },
    { time: 178, text: "Hangin' on the words you say" },
    { time: 181, text: "And I've been known to give my all" },
    { time: 184, text: "Sittin' back, lookin' at" },
    { time: 186, text: "Every mess that I made" },
    { time: 191, text: "So don't call me \"baby\"" },
    { time: 197, text: "Unless you mean it" },
    { time: 202, text: "And don't tell me you need me" },
    { time: 207, text: "If you don't believe it" },
    { time: 212, text: "And let me know the truth" },
    { time: 214, text: "Before I dive right into you" },
    { time: 219, text: "Before I dive right into you" },
    { time: 224, text: "And before I dive right into you" }
  ]
}
